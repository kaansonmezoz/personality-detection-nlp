...
+-----------+-----------+-----------+------------+
| Analysts  |   0,799   |   0,408   |   0,5401   |
+-----------+-----------+-----------+------------+
| Diplomats |   0,366   |   0,476   |   0,4138   |
+-----------+-----------+-----------+------------+
| Explorers |     0     |     0     |     0      |
+-----------+-----------+-----------+------------+
| Sentinels |   0,0083  |   0,417   |   0,0162   |
+------------------------------------------------+
...
|   CLASS   |   Recall  | Precision |  F1-Score  |
+-----------+-----------+-----------+------------+
|     I     |   0,7342  |  0,5488   |   0,6281   |
+-----------+-----------+-----------+------------+
|     E     |   0,4012  |  0,6035   |   0,4819   |
+------------------------------------------------+
...
|   CLASS   |   Recall  | Precision |  F1-Score  |
+-----------+-----------+-----------+------------+
|     N     |   0,9997  |  0,7179   |   0,8356   |
+-----------+-----------+-----------+------------+
|     S     |  0,00077  |  0,5833   |   0,0015   |
+------------------------------------------------+
...
|   CLASS   |   Recall  | Precision |  F1-Score  |
+-----------+-----------+-----------+------------+
|     F     |   0,3095  |  0,6116   |   0,4110   |
+-----------+-----------+-----------+------------+
|     T     |   0,8287  |  0,5794   |   0,6819   |
+------------------------------------------------+
...
|   CLASS   |   Recall  | Precision |  F1-Score  |
+-----------+-----------+-----------+------------+
|     P     |   0,6466  |  0,5660   |   0,6036   |
+-----------+-----------+-----------+------------+
|     J     |   0,8287  |  0,5606   |   0,6687   |
+------------------------------------------------+
...
|   CLASS   |   Recall  | Precision |  F1-Score  |
+-----------+-----------+-----------+------------+
| Analysts  |   0,7094  |   0,4081  |   0,5181   |
+-----------+-----------+-----------+------------+
| Diplomats |   0,4718  |   0,4570  |   0,4642   |
+-----------+-----------+-----------+------------+
| Explorers | 0,0000913 |   0.5     |  0,0001825 |
+-----------+-----------+-----------+------------+
| Sentinels | 0,0086826 |   0,3946  |  0,01699   |
+------------------------------------------------+
...
|   CLASS   |   Recall  | Precision |  F1-Score  |
+-----------+-----------+-----------+------------+
|     I     |   0,5545  |  0,5533   |   0,5538   |
+-----------+-----------+-----------+------------+
|     E     |   0,5626  |  0,5638   |   0,5631   |
+------------------------------------------------+
...
|   CLASS   |   Recall  | Precision |  F1-Score  |
+-----------+-----------+-----------+------------+
|     N     |   0,0000  |  0,0000   |   0,5538   |
+-----------+-----------+-----------+------------+
|     S     |   0,0000  |  0,0000   |   0,5631   |
+------------------------------------------------+
...
|   CLASS   |   Recall  | Precision |  F1-Score  |
+-----------+-----------+-----------+------------+
|     F     |   0,0000  |  0,0000   |   0,5538   |
+-----------+-----------+-----------+------------+
|     T     |   0,0000  |  0,0000   |   0,5631   |
+------------------------------------------------+
...
|   CLASS   |   Recall  | Precision |  F1-Score  |
+-----------+-----------+-----------+------------+
|     P     |   0,0000  |  0,0000   |   0,5538   |
+-----------+-----------+-----------+------------+
|     J     |   0,0000  |  0,0000   |   0,5631   |
+------------------------------------------------+
...
ACTUAL   | N |   0.718  |  0.0000533 |             Accuracy : 0.6017846503818448
         ...
         +--------------+------------+
            ...
            Predicted                        
             ...
             |    F    |    T    |
         +---+---------+---------+
ACTUAL   | F |  0.154  |  0.321  |              Accuracy : 0.5974719058292546
         +---+---------+---------+
         | T |  0.075  |  0.448  |
         +---+---------+---------+
            ...
            Predicted                        
             ...
             |    P    |   J   |
         +---+---------+-------+
ACTUAL   | P |  0.350  | 0.162 |              Accuracy : 0.5744400225668237
         +---+---------+-------+
         | J |  0.252  | 0.234 |
         +---+---------+-------+
...
## Experiment 14
- Dataset: preprocessed_dataset_zemberek
- Feature extraction: TF
- Bu Zemberek verisetinde normalizasyon ve lemmatization aşamalarından hem önce hem de sonra stop words'ler ve bu stop words'lerin lemmaları çıkarıldı.

### RESULTS ~ Based on Classes

- accuracy : 0.43685971048192657
...
```
         ...
         |           |  Analysts  | Diplomats |  Explorers  |   Sentinels |
         +-----------+------------+-----------+-------------+-------------+
         | Analysts  |   26537    |   11442   |      8      |      45     |
         +-----------+------------+-----------+-------------+-------------+
ACTUAL   | Diplomats |   18125    |   19184   |      7      |      49     |
         +-----------+------------+-----------+-------------+-------------+
         | Explorers |   6723     |   4144    |      26     |      30     |
         +-----------+------------+-----------+-------------+-------------+
         | Sentinels |   11754    |   6762    |      3      |      94     |
         +------------------------+-------------------------+-------------+
...
```
            ...
            Predicted                        
             ...
             |    I    |    E    |
         +---+---------+---------+
ACTUAL   | I |  25928  |  30042  |                 Accuracy : 0.5732888096000488
         +-------------+---------+
         | E |  34788  |  40408  |
         +-------------+---------+
...
|   CLASS   |   Recall  | Precision |  F1-Score  |
+-----------+-----------+-----------+------------+
|     I     |   0,4632  |  0,4270   |   0,4443   |
+-----------+-----------+-----------+------------+
|     E     |   0,5373  |  0,5735   |   0,5548   |
+------------------------------------------------+
            ...
            Predicted                        
             ...
             |     N    |    S     |
         +---+----------+----------+
ACTUAL   | N |   94174  |    90    |             Accuracy : 0.7189744293490691
         +---+----------+----------+
         | S |   36771  |    131   |
         +--------------+----------+
...
|   CLASS   |   Recall  | Precision |  F1-Score  |
+-----------+-----------+-----------+------------+
|     N     |   0,9990  |  0,7191   |   0,8362   |
+-----------+-----------+-----------+------------+
|     S     |   0,0035  |  0,5927   |   0,0069   |
+------------------------------------------------+
            ...
            Predicted                        
             ...
             |    F    |    T    |
         +---+---------+---------+
ACTUAL   | F |  26079  |  36430  |              Accuracy : 0.6028932600011208
         +---+---------+---------+
         | T |  16368  |  52289  |
         +---+---------+---------+
...
|   CLASS   |   Recall  | Precision |  F1-Score  |
+-----------+-----------+-----------+------------+
|     F     |   0,4172  |  0,6143   |   0,4951   |
+-----------+-----------+-----------+------------+
|     T     |   0,7615  |  0,5893   |   0,6644   |
+------------------------------------------------+        
            ...
            Predicted                        
             ...
             |    P    |    J    |
         +---+---------+---------+
ACTUAL   | P |  48019  |  27328  |              Accuracy : 0.5929200081289374
         +---+---------+---------+
         | J |  36895  |  18924  |
         +---+---------+---------+
...
|   CLASS   |   Recall  | Precision |  F1-Score  |
+-----------+-----------+-----------+------------+
|     P     |   0,6373  |  0,5655   |   0,5992   |
+-----------+-----------+-----------+------------+
|     J     |   0,3390  |  0,4091   |   0,3707   |
+------------------------------------------------+
...
- Bu Zemberek verisetinde normalizasyon ve lemmatization aşamalarından hem önce hem de sonra stop words'ler ve bu stop words'lerin lemmaları çıkarıldı.
- sublinear_tf=True, norm='l2', encoding='utf-8', ngram_range=(1, 2), max_features=5000, analyzer = 'word', token_pattern=r'\w{1,}'


### RESULTS ~ Based on Classes


- accuracy : 0.42982665129177666
...
```
         ...
         |           |  Analysts  | Diplomats |  Explorers  |   Sentinels |
         +-----------+------------+-----------+-------------+-------------+
         | Analysts  |   26958    |   10933   |      0      |      141    |
         +-----------+------------+-----------+-------------+-------------+
ACTUAL   | Diplomats |   19306    |   17940   |      0      |      119    |
         +-----------+------------+-----------+-------------+-------------+
         | Explorers |   6950     |   3916    |      0      |      57     |
         +-----------+------------+-----------+-------------+-------------+
         | Sentinels |   12151    |   6257    |      0      |      205    |
         +------------------------+-------------------------+-------------+
        ...
        |   CLASS   |   Recall  | Precision |  F1-Score  |
        +-----------+-----------+-----------+------------+
        | Analysts  |   0,7088  |   0,4124  |   0,0000   |
        +-----------+-----------+-----------+------------+
        | Diplomats |   0,4801  |   0,4594  |   0,0000   |
        +-----------+-----------+-----------+------------+
        | Explorers |   0,0000  |   0.0000  |   0,0000   |
        +-----------+-----------+-----------+------------+
        | Sentinels |   0,0110  |   0,3927  |   0,0000   |
        +------------------------------------------------+
...
```
            ...
            Predicted                        
             ...
             |    I    |    E    |
         +---+---------+---------+
ACTUAL   | I |  35092  |  29738  |                 Accuracy : 0.5613649878779562
         +-------------+---------+
         | E |  27796  |  38540  |
         +-------------+---------+
...
+------------------------------------------------+
            ...
            Predicted                        
             ...
             |     N    |    S     |
         +---+----------+----------+
ACTUAL   | N |   94201  |    63    |             Accuracy : 0.7186084808563195
         +---+----------+----------+
         | S |   36846  |    56    |
         +--------------+----------+
...
+------------------------------------------------+         
            ...
            Predicted                        
             ...
             |    F    |    T    |
         +---+---------+---------+
ACTUAL   | F |  24737  |  37772  |              Accuracy : 0.5892304408154552
         +---+---------+---------+
         | T |  16107  |  52550  |
         +---+---------+---------+
...
+------------------------------------------------+
            ...
            Predicted                        
             ...
             |    P    |    J    |
         +---+---------+---------+
ACTUAL   | P |  46119  |  20824  |              Accuracy : 0.5656115151792386
         +---+---------+---------+
         | J |  36153  |  28070  |
         +---+---------+---------+
